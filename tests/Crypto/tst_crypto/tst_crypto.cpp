...
void tst_crypto::getPluginInfo()
{
    ...
    QCOMPARE(cryptoPluginNames.size(), expectedCryptoPlugins.size());
    QCOMPARE(QSet<QString>::fromList(cryptoPluginNames), QSet<QString>::fromList(expectedCryptoPlugins));
}
